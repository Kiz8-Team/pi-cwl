...
// ============================================================================
// OAuth API key resolution from ~/.claude/agent/auth.json
// ============================================================================

const AUTH_PATH = join(homedir(), ".claude", "agent", "auth.json");
...
/**
 * Resolve API key for a provider from ~/.claude/agent/auth.json
 *
...
/**
 * Check if a provider has credentials in ~/.claude/agent/auth.json
 */
...
export const PI_AGENT_DIR = join(homedir(), ".claude", "agent");

/**
 * Get an AuthStorage instance backed by ~/.claude/agent/auth.json
