...
export class SettingsManager {
	...
	getCommandTemplatePaths(): string[] {
		return [...(this.settings.commands ?? [])];
	}

	setCommandTemplatePaths(paths: string[]): void {
		this.globalSettings.commands = paths;
		this.markModified("commands");
		this.save();
	}

	setProjectCommandTemplatePaths(paths: string[]): void {
		const projectSettings = structuredClone(this.projectSettings);
		projectSettings.commands = paths;
		this.markProjectModified("commands");
		this.saveProjectSettings(projectSettings);
	}
