 ...
 * Encodes cwd into a safe directory name under ~/.claude/agent/sessions/.
 */
...
export class SessionManager {
	...
	setSessionFile(sessionFile: string): void {
		...
		if (existsSync(this.sessionFile)) {
			...
			if (this.fileEntries.length === 0) {
				...
				this.newSession(undefined, false);
	...
	newSession(options?: NewSessionOptions, persistImmediately: boolean = true): string | undefined {
		...
		if (this.persist) {
			...
			if (persistImmediately && this.sessionFile) {
				this._rewriteFile();
				this.flushed = true;
			}
		}
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default (~/.claude/agent/sessions/<encoded-cwd>/).
	 */
