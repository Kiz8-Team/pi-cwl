...
/** Get the global agent config directory (e.g., ~/.claude/agent/) */
...
/** Get the project-local agent data directory for a cwd (e.g., <cwd>/.claude/agent/) */
export function getProjectAgentDir(cwd: string = process.cwd()): string {
	return join(resolve(cwd), CONFIG_DIR_NAME, "agent");
}
...
/** Get path to command templates directory */
export function getCommandsDir(): string {
	return join(getAgentDir(), "commands");
}

/** Get path to the centralized sessions directory under the global agent dir */
export function getSessionsDir(_cwd: string = process.cwd()): string {
	return join(getAgentDir(), "sessions");
}

/** Get path to the centralized passive CWL JSON traces directory under the global agent dir */
export function getCwlTracesDir(_cwd: string = process.cwd()): string {
	return join(getAgentDir(), "cwl");
}

/** Get the app-specific global config directory (e.g., ~/.claude/pi/) */
export function getAppConfigDir(): string {
	return join(homedir(), CONFIG_DIR_NAME, APP_NAME);
}

/** Get path to the app-specific persistent config.json */
